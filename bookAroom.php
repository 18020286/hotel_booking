          ...
          <div class="card-columns">
                ...
                <?php 
                  ...
                  $departure =  $_SESSION['departure'] ;
                   $query = "SELECT * FROM `tblroom` r ,`tblaccomodation` a WHERE r.`ACCOMID`=a.`ACCOMID` AND `ROOMNUM` > 0 AND `ACCOMODATION`='" . $_POST['accomodation'] . "' AND `NUMPERSON` = " . $_POST['person'];
                  $mydb->setQuery($query);
...
// filtering the rooms
 // ======================================================================================================
                    $mydb->setQuery("SELECT * FROM `tblreservation` WHERE ((
                        ...
                        ) AND STATUS <> 'Checkedout' AND STATUS <> 'Cancelled'
