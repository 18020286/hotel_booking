            ...
            <ul class="dropdown-menu nav nav-stacked">    
              <li class="widget-user-header bg-yellow">
                <div class="widget-user-image">
                  <img class="img-circle" style="cursor:pointer;width:auto;height:60px;padding:0;"  data-target="#myModal" data-toggle="modal" src="<?php echo WEB_ROOT. $result->LOCATION;  ?>" alt="User Avatar">
                </div> 
