			  	...
			  	<?php 
					...
					//echo '<td width="5%" align="center"></td>';
			  		...
			  		echo '<td align="left"  width="120"><input type="checkbox" name="selector[]" id="selector[]" value="'.$result->ROOMID. '"/> 
			  				<a href="index.php?view=editpic&id='.$result->ROOMID.'"><img src="'. $result->ROOMIMAGE.'" width="60" height="40" title="'. $result->ROOM .'"/> </a></td>';
			  		// 
					echo '<td>
							<a href="index.php?view=edit&id='.$result->ROOMID.'"><span class="glyphicon glyphicon-pencil">&nbsp;</a>
							<a href="index.php?view=view&id='.$result->ROOMID.'">'. $result->ROOM.' ('. $result->ROOMDESC.')
							</a>
